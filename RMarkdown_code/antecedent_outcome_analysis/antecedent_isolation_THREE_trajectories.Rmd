...
**IMPORTANT NOTE**
All multinomial analyses will be rerun in STATA applying the clustered standard errors correction for the twin pairs. 
...
{ cat(i)
  multinom.formula.ant <- as.formula(sprintf("class_reordered ~ %s + sex", antecedent.independent[i]))

  multinom.reg.ant <- multinom(multinom.formula.ant, data = dat)

  multinom.output.ant.full <- broom::tidy(multinom.reg.ant, conf.int = TRUE, exponentiate = TRUE, conf.level = 0.95)[-c(1,3,4,6),] %>%
...
{ cat(i)
  multinom.formula.ant.cont <- as.formula(sprintf("class_reordered ~ %s + sex", antecedent.independent.continuous.loop[i]))

  multinom.reg.ant.cont <- multinom(multinom.formula.ant.cont, data = dat)

  multinom.output.ant.full.cont <- broom::tidy(multinom.reg.ant.cont, conf.int = TRUE, exponentiate = TRUE, conf.level = 0.95)[-c(1,3,4,6),] %>%
    dplyr::rename(Class = y.level,
           RRR = estimate,
           RRR.conf.low = conf.low,
           RRR.conf.high = conf.high)
...
multinom.formula.ant.social.block <- as.formula(class_reordered ~ SES_binary_releveled + problems_neighbours_05 + number_children_school_free_meals_05 + sex)

multinom.reg.ant.social.block <- multinom(multinom.formula.ant.social.block, data = dat)

multinom.output.ant.social.block <- broom::tidy(multinom.reg.ant.social.block, conf.int = TRUE, exponentiate = TRUE, conf.level = 0.95)[-c(1,5,6,10),] %>%
    dplyr::rename(Class = y.level,
           RRR = estimate,
           RRR.conf.low = conf.low,
           RRR.conf.high = conf.high)
...
```{r table social block}
kable(multinom.output.ant.social.block.full)
```
...
multinom.formula.ant.social.block.cont <- as.formula(class_reordered ~ SES_binary_releveled + z_score.problems_neighbours_05 + z_score.number_children_school_free_meals_05 + sex)

multinom.reg.ant.social.block.cont <- multinom(multinom.formula.ant.social.block.cont, data = dat)

multinom.output.ant.social.block.cont <- broom::tidy(multinom.reg.ant.social.block.cont, conf.int = TRUE, exponentiate = TRUE, conf.level = 0.95)[-c(1,5,6,10),] %>%
    dplyr::rename(Class = y.level,
           RRR = estimate,
           RRR.conf.low = conf.low,
           RRR.conf.high = conf.high)
...
```{r table social block zscore}
kable(multinom.output.ant.social.block.full.cont)
```
...
multinom.formula.ant.home.block <- as.formula(class_reordered ~ child_harm_recoded_05 + maternal_warmth_continuous_05 + any_domestic_violence_05 + total_social_support_05 + total_activities_with_mum_05 + sex)

multinom.reg.ant.home.block <- multinom(multinom.formula.ant.home.block, data = dat)

multinom.output.ant.home.block <- broom::tidy(multinom.reg.ant.home.block, conf.int = TRUE, exponentiate = TRUE, conf.level = 0.95)[-c(1,7,8,14),] %>%
    dplyr::rename(Class = y.level,
           RRR = estimate,
           RRR.conf.low = conf.low,
           RRR.conf.high = conf.high)
...
```{r table home block}
kable(multinom.output.ant.home.block.full)
```
...
multinom.formula.ant.home.block.cont <- as.formula(class_reordered ~ child_harm_recoded_05 + z_score.maternal_warmth_continuous_05 + any_domestic_violence_05 + z_score.total_social_support_05 + z_score.total_activities_with_mum_05 + sex)

multinom.reg.ant.home.block.cont <- multinom(multinom.formula.ant.home.block.cont, data = dat)

multinom.output.ant.home.block.cont <- broom::tidy(multinom.reg.ant.home.block.cont, conf.int = TRUE, exponentiate = TRUE, conf.level = 0.95)[-c(1,7,8,14),] %>%
    dplyr::rename(Class = y.level,
           RRR = estimate,
           RRR.conf.low = conf.low,
           RRR.conf.high = conf.high)
...
```{r table home block zscore}
kable(multinom.output.ant.home.block.full.cont)
```
...
```{r table parent block}
kable(multinom.output.ant.parent.block.full)
```
...
multinom.formula.ant.parent.block.cont <- as.formula(class_reordered ~ maternal_depression_lifetime_05 + z_score.maternal_personality_openness_05 + z_score.maternal_personality_conscientiousness_05 + z_score.maternal_personality_extroversion_05 + z_score.maternal_personality_agreeableness_05 + z_score.maternal_personality_neuroticism_05 + z_score.antisocial_behaviour_parent_05 + sex) #alcoholism removed

multinom.reg.ant.parent.block.cont <- multinom(multinom.formula.ant.parent.block.cont, data = dat)

multinom.output.ant.parent.block.cont <- broom::tidy(multinom.reg.ant.parent.block.cont, conf.int = TRUE, exponentiate = TRUE, conf.level = 0.95)[-c(1,9,10,18),] %>%
    dplyr::rename(Class = y.level,
           RRR = estimate,
           RRR.conf.low = conf.low,
           RRR.conf.high = conf.high)
...
```{r table parent block zscore}
kable(multinom.output.ant.parent.block.full.cont)
```
...
multinom.formula.ant.neuro.block <- as.formula(class_reordered ~ IQ_05 + executive_function_05 + theory_of_mind_05 + sex)

multinom.reg.ant.neuro.block <- multinom(multinom.formula.ant.neuro.block, data = dat)

multinom.output.ant.neuro.block <- broom::tidy(multinom.reg.ant.neuro.block, conf.int = TRUE, exponentiate = TRUE, conf.level = 0.95)[-c(1,5,6,10),] %>%
   dplyr::rename(Class = y.level,
           RRR = estimate,
           RRR.conf.low = conf.low,
           RRR.conf.high = conf.high)
...
```{r table neuro block}
kable(multinom.output.ant.neuro.block.full)
```
...
multinom.formula.ant.neuro.block.cont <- as.formula(class_reordered ~ z_score.IQ_05 + z_score.executive_function_05 + z_score.theory_of_mind_05 + sex)

multinom.reg.ant.neuro.block.cont <- multinom(multinom.formula.ant.neuro.block.cont, data = dat)

multinom.output.ant.neuro.block.cont <- broom::tidy(multinom.reg.ant.neuro.block.cont, conf.int = TRUE, exponentiate = TRUE, conf.level = 0.95)[-c(1,5,6,10),] %>%
    dplyr::rename(Class = y.level,
           RRR = estimate,
           RRR.conf.low = conf.low,
           RRR.conf.high = conf.high)
...
```{r table neuro block zscore}
kable(multinom.output.ant.neuro.block.full.cont)
```
...
multinom.formula.ant.emo.block <- as.formula(class_reordered ~ externalising_combined_05 + internalising_combined_excl_sis_05 + ADHD_combined_05 + prosocial_behaviours_combined_05 + sex)

multinom.reg.ant.emo.block <- multinom(multinom.formula.ant.emo.block, data = dat)

multinom.output.ant.emo.block <- broom::tidy(multinom.reg.ant.emo.block, conf.int = TRUE, exponentiate = TRUE, conf.level = 0.95)[-c(1,6,7,12),] %>%
    dplyr::rename(Class = y.level,
           RRR = estimate,
           RRR.conf.low = conf.low,
           RRR.conf.high = conf.high)
...
```{r table emo block}
kable(multinom.output.ant.emo.block.full)
```
...
```{r emo block regression}
multinom.formula.ant.emo.block.cont <- as.formula(class_reordered ~ z_score.externalising_combined_05 + z_score.internalising_combined_excl_sis_05 + z_score.ADHD_combined_05 + z_score.prosocial_behaviours_combined_05 + sex)

multinom.reg.ant.emo.block.cont <- multinom(multinom.formula.ant.emo.block.cont, data = dat)

multinom.output.ant.emo.block.cont <- broom::tidy(multinom.reg.ant.emo.block.cont, conf.int = TRUE, exponentiate = TRUE, conf.level = 0.95)[-c(1,6,7,12),] %>%
    dplyr::rename(Class = y.level,
           RRR = estimate,
           RRR.conf.low = conf.low,
           RRR.conf.high = conf.high)
...
```
```{r table emo block zscore}
kable(multinom.output.ant.emo.block.full.cont)
```
...
```{r table all sig}
kable(multinom.output.ant.all.full)
```
...
```{r table all sig zscore}
kable(multinom.output.ant.all.full.cont)
```
...
# Multinomial regression without stepwise approach

Due to critiques of the step-wise regression approach - have run a full model with all antecedents included. 

```{r multinomial regression for entire model}
multinom.formula.ant.all.cont.FULL <- as.formula(class_reordered ~ 
                                              SES_binary_releveled + 
                                              z_score.acorn_continuous_05 +
                                              z_score.vandalism_05 +
                                              z_score.problems_neighbours_05 +
                                              z_score.number_children_school_05 +
                                              z_score.number_children_school_free_meals_05 +
                                              ...
                                              z_score.ADHD_combined_05 +
                                              z_score.prosocial_behaviours_combined_05 +
                                              sex) # controlled for in all regressions

multinom.reg.ant.all.cont.FULL <- multinom(multinom.formula.ant.all.cont.FULL, data = dat)

multinom.output.ant.all.cont.FULL <- broom::tidy(multinom.reg.ant.all.cont.FULL, 
                                                 conf.int = TRUE, 
                                                 exponentiate = TRUE, 
                                                 conf.level = 0.95)[-c(1,29,30,58),] %>%
  dplyr::rename(Class = y.level,
           RRR = estimate,
           RRR.conf.low = conf.low,
           RRR.conf.high = conf.high)

multinom.output.ant.all.full.cont.FULL <- multinom.output.ant.all.cont.FULL %>%
  mutate(Variable = rep(name.list, 2)) %>%
    mutate(
    Significance = 
      if_else(
        p.value < 0.05, 
...
multinom.output.ant.all.full.cont.FULL <- multinom.output.ant.all.full.cont.FULL %>%
  select(
         Class,
         Variable,
         RRR,
...
```{r table all sig zscore}
kable(multinom.output.ant.all.full.cont.FULL)
```

```{r all sig block graph prep}
# Created a leveled factor for the variables
multinom.output.ant.all.full.cont.FULL$Variable <- factor(multinom.output.ant.all.full.cont.FULL$Variable,
                                     levels = paste(unique(paste(multinom.output.ant.all.full.cont.FULL$Variable)),
                                                    sep = ","))
```

```{r all sig block plot}
all.sig.plot.cont.FULL <- ggplot(
  multinom.output.ant.all.full.cont.FULL,
  aes(x = Variable,
      y = RRR,
      ymin = RRR.conf.low,
      ymax = RRR.conf.high,
...
all.sig.plot.cont.FULL

#save
ggsave(
  "All_antecedents_using_zscores.FULL_regression_model.png",
  plot = all.sig.plot.cont.FULL,
  device = "png",
  path = paste0(graph_save_data_path, "antecedents/analysis_interpretation"),
  width = 12,
  height = 8
...
# file.move("/Users/katiethompson/Documents/Stata/multinomial_results_si.txt", data_path, overwrite = TRUE)

# read in stata text file
...
```{r stata graph prep}
# Created a leveled factor for the variables
dat.stata.individual$Variable <- factor(dat.stata.individual$Variable,
                                     levels = paste(unique(paste(dat.stata.individual$Variable)),
                                                    sep = ","))
```

```{r stata plot}
stata.plot <- ggplot(
  dat.stata.individual, 
  aes(x = Variable,
      y = RRR,
      ymin = RRR.conf.low,
      ymax = RRR.conf.high,
...
```{r mlogit attempt}
# data.mlogit.long <- dfidx::dfidx(data = data.mlogit, idvar = id, shape = "wide", choice = "class_reordered")
# # data.mlogit.long.test <- mlogit.data(data = data.mlogit,shape = "wide", choice = "choice", alt.var = "class_reordered", alt.levels = c("Low stable", "Increasing", "Decreasing"))
# 
# library("mlogit")
# 
# mlogit.formula <- as.formula(class_reordered ~ 
#                                               SES_binary_releveled + 
#                                               z_score.acorn_continuous_05 +
#                                               z_score.vandalism_05 +
#                                               z_score.problems_neighbours_05 +
...
#                                               sex)
# 
# mlogit.formula.test <- as.formula(class_reordered ~ SES_binary_releveled + z_score.acorn_continuous_05 + sex)
# 
# mlogit.output <- mlogit(formula = class_reordered ~ 1 | SES_binary_releveled, data = data.mlogit.long, nests = "familyid")
```
