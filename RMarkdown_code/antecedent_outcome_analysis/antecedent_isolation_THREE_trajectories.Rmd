...
```{r load packages to calculate robust standard errors}
...
{ cat(i)
  ...
  ########### IN PROGRESS
  # test <- mlogit::mlogit.data(data = dat)   
  # multinom.reg.ant <- mlogit::mlogit(multinom.formula.ant, data = test)
  # 
  # cluster.im.mlogit(multinom.output.ant.full, dat = dat, cluster = ~ familyid, report = TRUE, truncate = TRUE)
  ##########
